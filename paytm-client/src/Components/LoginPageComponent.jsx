            ...
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    <img className="mx-auto h-16 w-auto"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPRdFfHg7DCdn3j8VAqEYH6uwPvubW9fA2PUNPdmDmFA&s" alt="Your Company"/>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-sm">
                                    <a href="#" className="font-semibold text-sky-600 hover:text-sky-400">
                                        Forgot password?
                                    </a>
                                </div>
                            </div>
